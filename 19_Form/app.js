...
app.get('/practice26.ejs', function (req, res) {
    res.render('practice26');
})


app.get('/practice27.ejs', function (req, res) {
...
app.get('/result26', function (req, res) {
    ...
    // res.send('get 요청 응답 성공');
    res.render('result26', { title: 'GET 요청 성공', result: req.query });
    });
...
app.post('/result27', function (req, res) {
    ...
    // res.send('get 요청 응답 성공');
    res.render('result27', { title: 'GET 요청 성공', postResult: req.body });
    });
